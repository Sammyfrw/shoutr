...
ActiveRecord::Schema.define(version: 20140630190736) do
  ...
  add_index "following_relationships", ["follower_id", "followed_user_id"], name: "following_relationships_index_unique_constraint", unique: true, using: :btree
